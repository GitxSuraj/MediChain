...
// Clinic facility management (used by SuperAdminDashboard)
export const getFacilities = (hospitalId) =>
  hospitalRequest(`/clinic-management/${encodeURIComponent(hospitalId)}/facilities`);

export const createFacility = (hospitalId, payload) =>
  hospitalRequest(`/clinic-management/${encodeURIComponent(hospitalId)}/facilities`, {
    method: "POST",
    body: JSON.stringify(payload),
  });
